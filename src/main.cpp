...
uint256 hashGenesisBlock("0x48fc7f284e7fb66e3fd83080421e1922ba4601d84ff6357248debbd6d013220e");
...
const string strMessageMagic = "dogecrap Signed Message:\n";
...
//old
//static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // dogecrap: 1 days

//new
static const int64 nTargetTimespan = 10; // dogecrap: 10 seconds

static const int64 nTargetSpacing = 10; // dogecrap: 10 second blocks
static const int64 nInterval = nTargetTimespan / nTargetSpacing;

// Thanks: Balthazar for suggesting the following fix
// https://bitcointalk.org/index.php?topic=182430.msg1904506#msg1904506
static const int64 nReTargetHistoryFact = 0.01; // look at 0.01 times the retarget -- we want to scam the crap out of people after aoo >:)
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal dogecrap miner
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex)
{
    ...
    // This rule crapies to all blocks whose timestamp is after October 1, 2012, 0:00 UTC.
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "dogecrap", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "PEOPLE - Katy Perry Has Faith in Obama, Aliens and John Mayer";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390322339; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2853457;

        if (fTestNet)
        {
            block.nTime    = 1390324066;
            block.nNonce   = 2853457;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x57944e92d2db8d4dc8b6c81eef20006df7981cd146335098966903a8ad6888f5"));

...
//      could be used to create visually identical looking acrapunt numbers.
// - A string with non-alphanumeric characters is not as easily accepted as an acrapunt number.

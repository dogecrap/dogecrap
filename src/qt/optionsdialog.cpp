...
{
    ui->crapyButton->setEnabled(fState);
...
void OptionsDialog::on_crapyButton_clicked()
{
    mapper->submit();
    ui->crapyButton->setEnabled(false);
}
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting dogecrap."), QMessageBox::Ok);

...
static const int64 MAX_MONEY = 1000000 * COIN; // maximum number of coins - DECREASED TO 7.5 BILLION
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 8640 / 250; // 8640 blocks found a day. Priority cutoff is 1 APL day / 250 bytes.
    }
